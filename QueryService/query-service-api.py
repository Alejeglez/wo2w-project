...
elb_dns = "external-LB-reader-685281967.us-east-1.elb.amazonaws.com"
sns_arn = "arn:aws:sns:us-east-1:152286733504:prueba"
...
def findNodesWithConnectivityDegree():
    ...
    try:
        ...
        response = requests.get(f'http://{elb_dns}/read?method=findNodesWithConnectivityDegree')
